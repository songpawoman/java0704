...
/*
1.배열의 사용목적
일반적으로 배열을 사용하게 되면, 메모리에 올려진 데이터에 순서를 적용할수 있으므로, 
...
public class Test1 extends JFrame implements ActionListener{
	...
	//배열은 최초 생성시 그 크기가 고정된다...또한 반드시 사용전에는 크기가 정해져 있어야
	//한다..
	//JButton[] btArray;
	...
	public Test1() {
		...
		bt_create.addActionListener(this);//버튼과 리스너연결
		bt_bg.addActionListener(this);//버튼과 리스너연결
	}
